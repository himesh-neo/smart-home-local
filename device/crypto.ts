 ...
 */
Utf8.encode = function(strUni:string) {
 ...
 */
Utf8.decode = function(strUtf:string) {
...
let Tea:any = {}; // Tea namespace


/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */

// supporting functions
Tea.strToLongs = function(s:string) { // convert string to array of longs, each containing 4 chars
...
Tea.longsToStr = function(l:Array<any>) { // convert array of longs back to string
...
let Base64:any = {}; // Base64 namespace
 ...
 */
Base64.encode = function(str:string, utf8encode:boolean) { // http://tools.ietf.org/html/rfc4648
 ...
 * @returns {String} decoded string
 */
Base64.decode = function(str:string, utf8decode:boolean) {
 ...
 */
export const decrypt = (ciphertext:string, password:string) =>{
